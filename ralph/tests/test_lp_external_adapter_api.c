...
static void test_public_adapter_validation_and_lifecycle(void) {
    ...
    ASSERT_INT_EQ(ralph_register_lp_external_adapter(NULL), -1,
                  "public adapter: reject NULL adapter");
    ASSERT_INT_EQ(ralph_is_lp_external_adapter_registered(RALPH_LP_EXTERNAL_PROVIDER_NONE), 0,
    ...
    ASSERT_INT_EQ(ralph_is_lp_external_adapter_registered(RALPH_LP_EXTERNAL_PROVIDER_NONE), 1,
    ...
    ASSERT_INT_EQ(ralph_is_lp_external_adapter_registered(RALPH_LP_EXTERNAL_PROVIDER_CLP), 1,
                  "public adapter: CLP registered");
    ASSERT_TRUE(strcmp(ralph_get_lp_external_provider_name(RALPH_LP_EXTERNAL_PROVIDER_GLPK), "GLPK") == 0,
                "public adapter: provider name GLPK");
    ASSERT_TRUE(strcmp(ralph_get_lp_external_provider_name(RALPH_LP_EXTERNAL_PROVIDER_CLP), "CLP") == 0,
