...
int main(void) {
    ...
    const PeriodicCostDeferCase periodic_cost_defer_cases[] = {
        ...
        {
            .name = "midrow phase1 periodic cost cap allows longer defer burst",
            .phase = 1,
            .m = 800,
            .use_bland = 0,
            .degenerate_count = 120,
            ...
            .expected_cap = 4,
            .expected_cap_blocked = 0,
            .expected_next_consecutive = 4,
            .expected_reason = LP_PERIODIC_COST_DAMPEN_DEFER
        },
        {
            .name = "midrow phase2 periodic cost cap allows longer defer burst",
            .phase = 2,
            .m = 800,
            .use_bland = 0,
            .degenerate_count = 120,
            ...
            .refactor_cost_samples = 2,
            .iter_cost_samples = 16,
            .consecutive_defers = 5,
            .expected_defer = 1,
            .expected_cap = 6,
            .expected_cap_blocked = 0,
            .expected_next_consecutive = 6,
            .expected_reason = LP_PERIODIC_COST_DAMPEN_DEFER
        }
    };
