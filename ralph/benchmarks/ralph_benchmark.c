    ...
    *out_nnz = 0;
    ...
    }
    {
        ...
        if (solver) {
            ...
            result.phase1_refactor_safety_forced = solver->perf_phase1_refactor_safety_forced;
            ...
            result.phase2_refactor_safety_forced = solver->perf_phase2_refactor_safety_forced;
