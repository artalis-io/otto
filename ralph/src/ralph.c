...
int ralph_set_glpk_policy_int_param(RalphModel *model,
                                           RalphParamId param,
                                           int value) {
    LPGLPKCompatConfig cfg;
...
int ralph_set_glpk_policy_double_param(RalphModel *model,
                                              RalphParamId param,
                                              double value) {
    LPGLPKCompatConfig cfg;
    ralph_glpk_policy_config_from_model(model, &cfg);
...
RalphModel* ralph_core_create(void) {
    ...
    model->dual_steepest_edge = -1; /* -1 = use solver default */
...
#define RALPH_LU_TELEM_COPY(field) telemetry->field = snapshot.field
    ...
    RALPH_LU_TELEM_COPY(backend_policy_luf_ft);
    RALPH_LU_TELEM_COPY(backend_policy_cbg);
    RALPH_LU_TELEM_COPY(backend_policy_cgr);
    ...
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_entries_total);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size1_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size1_ms);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size2_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size2_ms);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size3_4_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size3_4_ms);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size5_8_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size5_8_ms);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size9p_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_size9p_ms);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_reserved_present_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_reserved_present_entries);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_reserved_present_ms);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_reserved_alt_chosen_calls);
    RALPH_LU_TELEM_COPY(perf_sn_panel_pivot_search_reserved_alt_chosen_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_u_emit_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_u_emit_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_scan_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_scan_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_apply_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_apply_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_row_gather_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_col_indirection_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_outer_product_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_full_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_full_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols1_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols1_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols2_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols2_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols3_calls);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols3_ms);
    RALPH_LU_TELEM_COPY(perf_sn_size1_update_cols4_calls);
    ...
    RALPH_LU_TELEM_COPY(perf_sn_full_update_ms);
    RALPH_LU_TELEM_COPY(perf_sn_compact_update_ms);
