...
#define PHASE1_DIR_SKIP_LADDER_RESCUE_START 64
#define PHASE1_DIR_SKIP_LADDER_RESCUE_PERIOD 32
...
#define DENSE_SPIKE_WARMUP_PHASE2_MIDROW_MIN_M 700
#define DENSE_SPIKE_WARMUP_PHASE2_MIDROW_MAX_M 760
#define DENSE_SPIKE_WARMUP_PHASE2_MIDROW_MIN_UPDATES 16
...
int lp_refactor_policy_dense_spike_min_updates_override(int phase,
    ...
    if (phase == 2 &&
        m >= DENSE_SPIKE_WARMUP_PHASE2_MIDROW_MIN_M &&
        m < DENSE_SPIKE_WARMUP_PHASE2_MIDROW_MAX_M) {
        return DENSE_SPIKE_WARMUP_PHASE2_MIDROW_MIN_UPDATES;
    }
