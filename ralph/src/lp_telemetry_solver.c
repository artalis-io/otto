...
void lp_telemetry_reset_solver(SimplexSolver *solver) {
    ...
    solver->telemetry.perf_phase1_force_pivot_budget_dir_event_seen = 0;
    ...
    solver->telemetry.perf_phase1_force_extreme_catastrophic_tiny_theta_relax_applied = 0;
    ...
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_post_dir_skip_forced_refactor = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_refactor_force_lu_health = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_refactor_force_pivot_mode = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_refactor_ladder_force = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_next_failed_stabilize = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_next_ratio_breakdown = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_next_pivot_fail = 0;
    solver->telemetry.perf_phase1_force_extreme_tiny_theta_relax_next_pivot_success = 0;
    ...
    solver->telemetry.perf_phase1_dual_rescue_exit_time_limit = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_bad_numerics = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_no_progress = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_no_entering = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_pivot_refactor_failure = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_periodic_refactor_failure = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_max_iters = 0;
    solver->telemetry.perf_phase1_dual_rescue_exit_alloc_failure = 0;
    ...
    solver->telemetry.perf_phase1_failed_stabilize_retry_pool_samples = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_pool_eligible_total = 0;
    ...
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_samples = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_ratio_failed = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_dir_stable = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_dir_failed = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_dir_nnz_total = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_dir_nnz_max = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_dir_inf_total = 0.0;
    ...
    solver->telemetry.perf_phase1_force_extreme_followup_stabilized = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_ratio_breakdown = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_failed_stabilize = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_post_dir_skip_retry = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_post_dir_skip_dual_rescue = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_post_dir_skip_forced_refactor = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_next_failed_stabilize = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_next_ratio_breakdown = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_next_pivot_fail = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_next_pivot_success = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_samples = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_bound_geometry = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_bound_flip = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_tiny_theta = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_weak_leaving = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_ftran_shape = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_nnz_total = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_nnz_max = 0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_inf_total = 0.0;
    solver->telemetry.perf_phase1_force_extreme_followup_dir_inf_max = 0.0;
    solver->telemetry.perf_phase1_force_extreme_followup_pivot_abs_total = 0.0;
    solver->telemetry.perf_phase1_force_extreme_followup_pivot_abs_max = 0.0;
    solver->telemetry.perf_phase1_force_extreme_followup_theta_total = 0.0;
    solver->telemetry.perf_phase1_force_extreme_followup_theta_max = 0.0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_samples = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_bound_geometry = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_bound_flip = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_tiny_theta = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_weak_leaving = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_ftran_shape = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_nnz_total = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_nnz_max = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_inf_total = 0.0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_dir_inf_max = 0.0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_pivot_abs_total = 0.0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_pivot_abs_max = 0.0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_theta_total = 0.0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_shadow_followup_theta_max = 0.0;
    ...
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_le_30 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_le_100 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_le_1000 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_gt_1000 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_le_1e_8 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_le_1e_6 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_le_1e_4 = 0;
    solver->telemetry.perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_gt_1e_4 = 0;
    ...
    solver->telemetry.perf_phase1_window_pressure_windows_started = 0;
    solver->telemetry.perf_phase1_window_pressure_progress_resets = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_arms = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_blocked_pending = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_blocked_budget = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_reject_under_trigger = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_reject_failed_share = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_reject_dir_skip_share = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_reject_local_fail = 0;
    solver->telemetry.perf_phase1_window_pressure_force_pivot_reject_alternation = 0;
    solver->telemetry.perf_phase1_window_pressure_event_total = 0;
    solver->telemetry.perf_phase1_window_pressure_failed_stabilize_total = 0;
    solver->telemetry.perf_phase1_window_pressure_dir_skip_total = 0;
    solver->telemetry.perf_phase1_window_pressure_local_memory_fail_total = 0;
    solver->telemetry.perf_phase1_window_pressure_alternation_total = 0;
    solver->telemetry.perf_phase1_window_pressure_event_max = 0;
    solver->telemetry.perf_phase1_window_pressure_failed_stabilize_max = 0;
    solver->telemetry.perf_phase1_window_pressure_dir_skip_max = 0;
    solver->telemetry.perf_phase1_window_pressure_local_memory_fail_max = 0;
    solver->telemetry.perf_phase1_window_pressure_alternation_max = 0;
    ...
    solver->telemetry.perf_phase2_degenerate_episodes = 0;
    solver->telemetry.perf_phase2_degenerate_streak_max = 0;
    solver->telemetry.perf_phase2_theta_le_1e_9 = 0;
    solver->telemetry.perf_phase2_theta_le_1e_6 = 0;
    solver->telemetry.perf_phase2_theta_le_1e_3 = 0;
    solver->telemetry.perf_phase2_theta_gt_1e_3 = 0;
    solver->telemetry.perf_phase2_weak_pivot_samples = 0;
    solver->telemetry.perf_phase2_weak_pivot_ratio_total = 0.0;
    solver->telemetry.perf_phase2_weak_pivot_ratio_min = 0.0;
    solver->telemetry.perf_phase2_weak_pivot_ratio_le_1e_8 = 0;
    solver->telemetry.perf_phase2_weak_pivot_ratio_le_1e_6 = 0;
    solver->telemetry.perf_phase2_weak_pivot_ratio_le_1e_4 = 0;
    solver->telemetry.perf_phase2_weak_pivot_ratio_gt_1e_4 = 0;
    solver->telemetry.perf_phase2_repeat_entering_events = 0;
    solver->telemetry.perf_phase2_repeat_entering_max_streak = 0;
    solver->telemetry.perf_phase2_repeat_leaving_events = 0;
    solver->telemetry.perf_phase2_repeat_leaving_max_streak = 0;
    solver->telemetry.perf_phase2_bland_pricing_iters = 0;
    solver->telemetry.perf_phase2_adaptive_devex_partial_iters = 0;
    solver->telemetry.perf_phase2_bland_enter_episodes = 0;
    solver->telemetry.perf_phase2_bland_exit_episodes = 0;
    solver->telemetry.perf_phase2_perturb_applied = 0;
    solver->telemetry.perf_phase2_devex_reset_count = 0;
    solver->telemetry.perf_phase2_devex_age_max = 0;
    solver->telemetry.perf_phase2_degen_refactor_calls = 0;
    solver->telemetry.perf_phase2_degen_refactor_ratio_recovery = 0;
    solver->telemetry.perf_phase2_degen_refactor_pivot_recovery = 0;
    solver->telemetry.perf_phase2_degen_refactor_periodic_policy = 0;
    solver->telemetry.perf_phase2_degen_refactor_periodic_lu_health = 0;
    solver->telemetry.perf_phase2_degen_refactor_safety_forced = 0;
    solver->telemetry.perf_phase2_degen_escape_triggers = 0;
...
void lp_telemetry_snapshot_solver(const SimplexSolver *solver,
    ...
    COPY_SOLVER_FIELD(perf_phase1_force_pivot_budget_dir_event_seen);
    ...
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_catastrophic_tiny_theta_relax_applied);
    ...
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_post_dir_skip_forced_refactor);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_refactor_force_lu_health);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_refactor_force_pivot_mode);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_refactor_ladder_force);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_next_failed_stabilize);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_next_ratio_breakdown);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_next_pivot_fail);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_tiny_theta_relax_next_pivot_success);
    ...
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_time_limit);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_bad_numerics);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_no_progress);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_no_entering);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_pivot_refactor_failure);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_periodic_refactor_failure);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_max_iters);
    COPY_SOLVER_FIELD(perf_phase1_dual_rescue_exit_alloc_failure);
    ...
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_pool_samples);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_pool_eligible_total);
    ...
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_samples);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_ratio_failed);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_dir_stable);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_dir_failed);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_dir_nnz_total);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_dir_nnz_max);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_dir_inf_total);
    ...
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_stabilized);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_ratio_breakdown);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_failed_stabilize);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_post_dir_skip_retry);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_post_dir_skip_dual_rescue);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_post_dir_skip_forced_refactor);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_next_failed_stabilize);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_next_ratio_breakdown);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_next_pivot_fail);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_next_pivot_success);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_samples);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_bound_geometry);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_bound_flip);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_tiny_theta);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_weak_leaving);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_ftran_shape);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_nnz_total);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_nnz_max);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_inf_total);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_dir_inf_max);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_pivot_abs_total);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_pivot_abs_max);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_theta_total);
    COPY_SOLVER_FIELD(perf_phase1_force_extreme_followup_theta_max);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_samples);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_bound_geometry);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_bound_flip);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_tiny_theta);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_weak_leaving);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_ftran_shape);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_nnz_total);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_nnz_max);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_inf_total);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_dir_inf_max);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_pivot_abs_total);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_pivot_abs_max);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_theta_total);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_shadow_followup_theta_max);
    ...
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_le_30);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_le_100);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_le_1000);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_inf_ratio_gt_1000);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_le_1e_8);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_le_1e_6);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_le_1e_4);
    COPY_SOLVER_FIELD(perf_phase1_failed_stabilize_retry_dir_fail_pivot_ratio_gt_1e_4);
    ...
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_windows_started);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_progress_resets);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_arms);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_blocked_pending);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_blocked_budget);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_reject_under_trigger);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_reject_failed_share);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_reject_dir_skip_share);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_reject_local_fail);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_force_pivot_reject_alternation);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_event_total);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_failed_stabilize_total);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_dir_skip_total);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_local_memory_fail_total);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_alternation_total);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_event_max);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_failed_stabilize_max);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_dir_skip_max);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_local_memory_fail_max);
    COPY_SOLVER_FIELD(perf_phase1_window_pressure_alternation_max);
    ...
    COPY_SOLVER_FIELD(perf_phase2_degenerate_episodes);
    COPY_SOLVER_FIELD(perf_phase2_degenerate_streak_max);
    COPY_SOLVER_FIELD(perf_phase2_theta_le_1e_9);
    COPY_SOLVER_FIELD(perf_phase2_theta_le_1e_6);
    COPY_SOLVER_FIELD(perf_phase2_theta_le_1e_3);
    COPY_SOLVER_FIELD(perf_phase2_theta_gt_1e_3);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_samples);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_ratio_total);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_ratio_min);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_ratio_le_1e_8);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_ratio_le_1e_6);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_ratio_le_1e_4);
    COPY_SOLVER_FIELD(perf_phase2_weak_pivot_ratio_gt_1e_4);
    COPY_SOLVER_FIELD(perf_phase2_repeat_entering_events);
    COPY_SOLVER_FIELD(perf_phase2_repeat_entering_max_streak);
    COPY_SOLVER_FIELD(perf_phase2_repeat_leaving_events);
    COPY_SOLVER_FIELD(perf_phase2_repeat_leaving_max_streak);
    COPY_SOLVER_FIELD(perf_phase2_bland_pricing_iters);
    COPY_SOLVER_FIELD(perf_phase2_adaptive_devex_partial_iters);
    COPY_SOLVER_FIELD(perf_phase2_bland_enter_episodes);
    COPY_SOLVER_FIELD(perf_phase2_bland_exit_episodes);
    COPY_SOLVER_FIELD(perf_phase2_perturb_applied);
    COPY_SOLVER_FIELD(perf_phase2_devex_reset_count);
    COPY_SOLVER_FIELD(perf_phase2_devex_age_max);
    COPY_SOLVER_FIELD(perf_phase2_degen_refactor_calls);
    COPY_SOLVER_FIELD(perf_phase2_degen_refactor_ratio_recovery);
    COPY_SOLVER_FIELD(perf_phase2_degen_refactor_pivot_recovery);
    COPY_SOLVER_FIELD(perf_phase2_degen_refactor_periodic_policy);
    COPY_SOLVER_FIELD(perf_phase2_degen_refactor_periodic_lu_health);
    COPY_SOLVER_FIELD(perf_phase2_degen_refactor_safety_forced);
    COPY_SOLVER_FIELD(perf_phase2_degen_escape_triggers);
