 ...
 * Works with any WASM module that exports cc_* functions.
 */

/* Constants - should match CC_MONOSPACE_WIDTH_RATIO in cc_common.h */
 ...
 * @param {Object} wasm - WASM exports with cc_* functions
...
export function renderTextCursor(renderer, wasm, font, projMatrix, inputBounds, options = {}) {
    ...
    const focusedText = getWasmString(wasm, wasm.cc_focused_text(), wasm.cc_focused_text_len());
