...
├── scripts/
│   └── build-api-docs.py             # Single script does everything
├── carta/
...
## Generator: scripts/build-api-docs.py
...
def generate_wasm_exports(exports, output_path):
    ...
    lines = ['# Generated by build-api-docs.py - do not edit', '']
...
# carta/wasm/Makefile
-include exports.mk  # Generated by build-api-docs.py
...
3. ✅ Created `scripts/build-api-docs.py` with annotation parser
...
- `scripts/build-api-docs.py` - Parser for `/*@api ... */` annotations
...
3. ✅ CI integration via `scripts/ci-pipeline.sh lint` stage
...
./scripts/ci-pipeline.sh lint # Includes api-docs-check in lint stage
```
